 ...
 * Vector3 class are enough to warrant abstraction in a more complicated system,
...
public class Color {
	 ...
	 *            the input red value
	 * @param inG
	 *            the input green value
	 * @param inB
	 *            the input blue value
	 */
	 ...
	 *            the scale factor
	 * @param rhs
	 *            the color to be scaled and added
	 */
	 ...
	 * 
	 * @param gamma
	 *            the gamma value to use (2.2 is generally used).
	 */
