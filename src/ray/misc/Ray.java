...
public class Ray {
	...
	/**
	 * It is convenient to have a ray have a start and end t values. The start
	 * value lets the ray be offset slightly from surfaces avoiding self
	 * intersection through numerical inaccuracies, and the end value lets rays
	 * be cut off at certain points (such as for shadow rays).
	 */
	...
	/**
	 * Sets outPoint to the point on this ray t units from the origin. Note that
	 * t can be considered as distance along this ray only if the ray direction
	 * is normalized.
	 * 
	 * @param outPoint
	 *            the output point
	...
	/**
	 * Moves the origin of the ray EPISILON units along ray. Avoids self
	 * intersection when casting rays from surfaces.
	 */
