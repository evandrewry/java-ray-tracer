...
/**
 * A background is responsible for assigning radiances to rays that don't hit
 * any geometry. This interface has the standard form for a function that can be
 * importance sampled. It could be extended to allow for stratification or to
 * give the sampling code access to some information about the shading point to
 * enable better sampling methods.
 * 
 * @author srm
 */
public interface Background {
	 ...
	 * @param outRadiance
	 *            The radiance seen in that direction
	 */
	 ...
	 * @param outDirection
	 *            The chosen direction direction
	 */
