 ...
 * contain a material pointer. Material pointers are left under the control of
 * the implementation. This allows very lightweight surfaces, a good example are
 * MeshTriangle which merely reference triangles in a TriangleMesh surface, to
 * share a material pointer.
 * 
 * @author ags
 */
public abstract class Surface {
	...
	public static final SurfaceComparator X_COMPARE = new SurfaceComparator(
			SurfaceComparator.X_AXIS);
	public static final SurfaceComparator Y_COMPARE = new SurfaceComparator(
			SurfaceComparator.Y_AXIS);
	public static final SurfaceComparator Z_COMPARE = new SurfaceComparator(
			SurfaceComparator.Z_AXIS);
	...
	/**
	 * Choose a random point to sample illumination from this surface as an
	 * emitter.
	 */
	...
	/**
	 * The pdf corresponding to chooseSamplePoint. LRec must describe a visible
	 * point on a luminaire.
	 */
	 ...
	 * 
	 * @author arbree Nov 18, 2005 Surface.java Copyright 2005 Program of
