...
public class Triangle extends Surface {
	 ...
	 * 
	 * @param newV0
	 *            The first vertex of the new triangle.
	 * @param newV1
	 *            The second vertex of the new triangle.
	 * @param newV2
	 *            The third vertex of the new triangle.
	 * @param newMaterial
	 *            The material of the new triangle.
	 */
	public Triangle(Point3 newV0, Point3 newV1, Point3 newV2,
	...
	public boolean chooseSamplePoint(Point3 p, Point2 seed,
		...
		return true; // always return true, since lRec.emitDir.dot(lRec.frame.w)
						// will be checked later on in Scene class's method
		// return (lRec.emitDir.dot(lRec.frame.w) > 0); // SHOULD we check if
		// this ray can arrive the surface point, iRec.frame.o
	}

	/**
	 * Triangle intersections should be FAST! Generally, most of the time in a
	 * ray tracer is spent in this method (as much as 50%). In practice that
	 * means that a triangle intersection method should not create any new
	 * objects, amd should attempt to perform as little branching as necessary.
	 * Also note that you can create as many primitive types in a method as you
	 * want. Allociation of primitives is not from the heap and literally takes
	 * no time over the cost of calling the method. This is why I can freely
	 * allocate so many doubles.
	 * 
	...
	public void getCenter(Point3 outCenter) {
		...
		outCenter.set(v0.x + v1.x + v2.x, v0.y + v1.y + v2.y, v0.z + v1.z
				+ v2.z);
