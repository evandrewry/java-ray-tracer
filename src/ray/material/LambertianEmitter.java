...
/**
 * A Lambertian emitter, which emits the same radiance at all points and in all
 * directions.
 * 
 * @author srm
 */
public class LambertianEmitter implements Material {
	...
	public void setRadiance(Color emittedRadiance) {
		this.radiance.set(emittedRadiance);
	}
