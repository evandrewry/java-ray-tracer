 ...
 * 
 * @author arbree Nov 10, 2005 AxisAlignedBoundingBox.java Copyright 2005
...
public class AxisAlignedBoundingBox {
	...
	public boolean intersects(AxisAlignedBoundingBox box) {
		...
		return ((box.xMin < xMax && box.xMax > xMin)
				&& (box.yMin < yMax && box.yMax > yMin) && (box.zMin < zMax && box.zMax > zMin));
	...
	public String toString() {
		...
		return "Box: (" + xMin + "," + yMin + "," + zMin + ")x(" + xMax + ","
				+ yMax + "," + zMax + ")";
