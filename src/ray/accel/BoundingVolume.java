...
/**
 * @author arbree Nov 10, 2005 BoundingVolume.java Copyright 2005 Program of
...
public class BoundingVolume implements AccelerationStructure {
	...
	/**
	 * Construct a bounding volume for the given surfaces, subdividing if
	 * necessary.
	 * 
	 * @param inSurfaces
	 */
	public BoundingVolume(ArrayList<Surface> inSurfaces) {
		...
		System.out
				.println("Volume contains " + inSurfaces.size() + " objects.");
	...
	/**
	 * Set outRecord to the first intersection of ray with this bounding volume.
	 * Return true if there was an intersection and false otherwise. If no
	 * intersection was found outRecord is unchanged.
	 * 
	 * @param outRecord
