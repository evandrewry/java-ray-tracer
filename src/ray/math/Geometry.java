...
public class Geometry {
	...
	/**
	 * @param seed
	 *            A point randomly distributed in the unit square
	 * @param outDir
	 *            A vector randomly distributed over the hemisphere wrt. proj.
	 *            solid angle
	 */
	 ...
	 *            A point randomly distributed in the unit square
	 * @param outDir
	 *            A vector randomly distributed over the hemisphere wrt. solid
	 *            angle (area)
	 */
	 ...
	 *            A point randomly distributed in the unit square
	 * @param outDir
	 *            A vector randomly distributed over the sphere wrt. solid angle
	 *            (area)
	 */
	...
	/**
	 * Here we use a better way to sample in the triangle, because it doesn't
	 * use squre root which is computationally expensive.
	 * 
	 * @param seed
	 *            A point randomly distributed in the unit square
	 * @param baryPt
	 *            A 2D point randomly distributed over the triangle (0,0),
	 *            (1,0), (0,1). Its coordinates are the beta and gamma
	 ...
	 *            A point randomly distributed in the unit square
	 * @param polarPt
	 *            A 2D point randomly distributed over the unit disc, in polar
	 *            coordinates (polarPt.x is radius, polarPt.y is angle).
	 */
