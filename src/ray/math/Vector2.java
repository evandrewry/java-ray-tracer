...
public class Vector2 extends Tuple2 {
	...
	/**
	 * Normalize this Vector2 so that its length is 1.0. If the length is 0, no
	 * action is taken.
	 */
	...
	/**
	 * Substract a Vector2 from this Vector2, storing the result in this
	 * Vector2.
	 * 
	 * @param vector
	...
	/**
	 * Subtract one Point2 from another Point2, storing the result in this
	 * Vector2.
	 * 
	 * @param p1
	 *            the first operand
