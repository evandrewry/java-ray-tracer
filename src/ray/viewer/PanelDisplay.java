...
public class PanelDisplay extends JPanel {
	 ...
	 */
	public synchronized void saveCurrentImage(File inFilename)
			throws java.io.IOException {
	...
	public void paintComponent(Graphics g) {
		...
		synchronized (this) { // make sure image doesn't change while we are
								// drawing
			// it
	 ...
	 * 
	 * @param image
	 *            the image to place in the buffer
	 */
	private synchronized void bufferImage(Image image, int xl, int yl, int xh,
			int yh) {
